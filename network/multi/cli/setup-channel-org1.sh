...
peer channel create -o orderer0.fastcampus.com:7050 -c mychannel -f ./channel-artifacts/channel.tx \
...
peer channel update -o orderer0.fastcampus.com:7050 -c mychannel -f ./channel-artifacts/${CORE_PEER_LOCALMSPID}anchors.tx  \
--tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/fastcampus.com/orderers/orderer0.fastcampus.com/msp/tlscacerts/tlsca.fastcampus.com-cert.pem
